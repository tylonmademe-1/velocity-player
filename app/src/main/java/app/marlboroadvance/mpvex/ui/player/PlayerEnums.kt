...
enum class FilterPreset(
  ...
  GOLDEN_HOUR(
    ...
    description = "Warm sunset glow with rich oranges",
    brightness = 8,
    saturation = 30,
    contrast = 10,
    gamma = 8,
  ...
  ARCTIC(
    displayName = "Arctic",
    description = "Icy cold tones with crisp clarity",
    brightness = 5,
    saturation = -10,
    contrast = 15,
    gamma = 5,
  ...
  ANIME(
    displayName = "Anime",
    description = "Punchy saturated anime style",
    brightness = 10,
    saturation = 35,
    contrast = 5,
    gamma = 5,
  ...
  HORROR(
    displayName = "Horror",
    description = "Desaturated cold tones for tension",
    brightness = -15,
    saturation = -25,
    contrast = 20,
    gamma = -10,
  ...
  RETRO_VHS(
    ...
    description = "80s VHS tape look with soft blur",
    brightness = 5,
    saturation = -10,
    contrast = -15,
    gamma = 10,
  ...
  DOCUMENTARY(
    ...
    description = "Natural neutral tones for realism",
    brightness = 0,
    saturation = -8,
    contrast = 8,
    gamma = 0,
  ...
  SUNSET(
    displayName = "Sunset",
    description = "Deep reds and purples of dusk",
    brightness = -5,
    saturation = 25,
    contrast = 15,
    gamma = -5,
