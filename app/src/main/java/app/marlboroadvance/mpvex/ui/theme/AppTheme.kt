...
enum class AppTheme(
  ...
  HotPink(
    titleRes = R.string.theme_hot_pink,
    primaryLight = Color(0xFFFF1493),
    primaryDark = Color(0xFFFF69B4),
    secondaryLight = Color(0xFFFF69B4),
    secondaryDark = Color(0xFFFFB6C1),
    tertiaryLight = Color(0xFFFF007F),
    tertiaryDark = Color(0xFFFF85C2),
    backgroundLight = Color(0xFFFFF0F5),
    backgroundDark = Color(0xFF1A0010),
  ),
  DeepPink(
    titleRes = R.string.theme_deep_pink,
    primaryLight = Color(0xFFC2185B),
    primaryDark = Color(0xFFF48FB1),
    secondaryLight = Color(0xFFAD1457),
    secondaryDark = Color(0xFFF06292),
    tertiaryLight = Color(0xFF880E4F),
    tertiaryDark = Color(0xFFFF80AB),
    backgroundLight = Color(0xFFFFF5F8),
    backgroundDark = Color(0xFF1A0A12),
  ),
  AmoledPink(
    titleRes = R.string.theme_amoled_pink,
    primaryLight = Color(0xFFFF1493),
    primaryDark = Color(0xFFFF69B4),
    secondaryLight = Color(0xFFFF69B4),
    secondaryDark = Color(0xFFFFB6C1),
  ...
  PureBlack(
    ...
    secondaryDark = Color(0xFFE0E0E0),
    tertiaryLight = Color(0xFF757575),
    tertiaryDark = Color(0xFFBDBDBD),
    backgroundLight = Color(0xFFFAFAFA),
    backgroundDark = Color(0xFF000000),
  ),
  Carbon(
    titleRes = R.string.theme_carbon,
    primaryLight = Color(0xFF37474F),
    primaryDark = Color(0xFF90A4AE),
    secondaryLight = Color(0xFF263238),
    secondaryDark = Color(0xFF78909C),
    tertiaryLight = Color(0xFF455A64),
  ...
  MidnightBlue(
    ...
    tertiaryDark = Color(0xFFC5CAE9),
    backgroundLight = Color(0xFFF3F4FF),
    backgroundDark = Color(0xFF080B1A),
  ),
  ElectricPurple(
    titleRes = R.string.theme_electric_purple,
    primaryLight = Color(0xFF7B1FA2),
    primaryDark = Color(0xFFE040FB),
    secondaryLight = Color(0xFF6A1B9A),
    secondaryDark = Color(0xFFCE93D8),
    tertiaryLight = Color(0xFF4A148C),
    tertiaryDark = Color(0xFFEA80FC),
    backgroundLight = Color(0xFFFAF0FF),
    backgroundDark = Color(0xFF0D001A),
  ),
  NeonGreen(
    titleRes = R.string.theme_neon_green,
    primaryLight = Color(0xFF00C853),
    primaryDark = Color(0xFF69FF47),
    secondaryLight = Color(0xFF00BFA5),
    secondaryDark = Color(0xFF64FFDA),
    tertiaryLight = Color(0xFF00E676),
    tertiaryDark = Color(0xFFB9F6CA),
    backgroundLight = Color(0xFFF0FFF4),
    backgroundDark = Color(0xFF001A08),
  ),
  BloodOrange(
    titleRes = R.string.theme_blood_orange,
    primaryLight = Color(0xFFBF360C),
    primaryDark = Color(0xFFFF6E40),
    secondaryLight = Color(0xFFDD2C00),
    secondaryDark = Color(0xFFFF9E80),
    tertiaryLight = Color(0xFF870000),
    tertiaryDark = Color(0xFFFFAB91),
    backgroundLight = Color(0xFFFFF3EE),
    backgroundDark = Color(0xFF1A0500),
  ),
  Golden(
    titleRes = R.string.theme_golden,
    primaryLight = Color(0xFFB8860B),
    primaryDark = Color(0xFFFFD700),
    secondaryLight = Color(0xFFDAA520),
    secondaryDark = Color(0xFFFFEC8B),
    tertiaryLight = Color(0xFF8B6914),
    tertiaryDark = Color(0xFFFFC200),
    backgroundLight = Color(0xFFFFFBEE),
    backgroundDark = Color(0xFF1A1500),
  ),
  Lemon(
    titleRes = R.string.theme_lemon,
    primaryLight = Color(0xFFCDC000),
    primaryDark = Color(0xFFF5F500),
    secondaryLight = Color(0xFFB8A800),
    secondaryDark = Color(0xFFEEEE55),
    tertiaryLight = Color(0xFF9B8F00),
    tertiaryDark = Color(0xFFFFFF99),
    backgroundLight = Color(0xFFFFFFF0),
    backgroundDark = Color(0xFF181800),
  ),
  Peach(
    titleRes = R.string.theme_peach,
    primaryLight = Color(0xFFFF7043),
    primaryDark = Color(0xFFFFAB91),
    secondaryLight = Color(0xFFFF8A65),
    secondaryDark = Color(0xFFFFCCBC),
    tertiaryLight = Color(0xFFE64A19),
    tertiaryDark = Color(0xFFFF8A65),
    backgroundLight = Color(0xFFFFF8F5),
    backgroundDark = Color(0xFF1A0D08),
  ),
  Mint(
    ...
    secondaryDark = Color(0xFFB2DFDB),
    tertiaryLight = Color(0xFF00796B),
    tertiaryDark = Color(0xFF4DB6AC),
    backgroundLight = Color(0xFFF0FFFE),
    backgroundDark = Color(0xFF001A18),
  ),
  IceBlue(
    titleRes = R.string.theme_ice_blue,
    primaryLight = Color(0xFF0288D1),
    primaryDark = Color(0xFF81D4FA),
    secondaryLight = Color(0xFF0277BD),
    secondaryDark = Color(0xFFB3E5FC),
    tertiaryLight = Color(0xFF01579B),
    tertiaryDark = Color(0xFFE1F5FE),
    backgroundLight = Color(0xFFF0F9FF),
    backgroundDark = Color(0xFF001525),
  ),
  Cherry(
    titleRes = R.string.theme_cherry,
    ...
    tertiaryDark = Color(0xFFFF80AB),
    backgroundLight = Color(0xFFFFF5F5),
    backgroundDark = Color(0xFF1A0000),
  ),
  Galaxy(
    titleRes = R.string.theme_galaxy,
    primaryLight = Color(0xFF4527A0),
    primaryDark = Color(0xFFB39DDB),
    secondaryLight = Color(0xFF6A1B9A),
    secondaryDark = Color(0xFFCE93D8),
    tertiaryLight = Color(0xFF1565C0),
    tertiaryDark = Color(0xFF90CAF9),
    backgroundLight = Color(0xFFF5F0FF),
    backgroundDark = Color(0xFF05001A),
  ),
  Copper(
    titleRes = R.string.theme_copper,
    primaryLight = Color(0xFFB87333),
    primaryDark = Color(0xFFDDA05A),
    secondaryLight = Color(0xFF8B5E3C),
    secondaryDark = Color(0xFFC49A6C),
    tertiaryLight = Color(0xFF7B4F2E),
    tertiaryDark = Color(0xFFE8B88A),
    backgroundLight = Color(0xFFFFF8F0),
    backgroundDark = Color(0xFF1A0E00),
  ),
  Jade(
    titleRes = R.string.theme_jade,
    primaryLight = Color(0xFF00A86B),
    primaryDark = Color(0xFF5CDB95),
    secondaryLight = Color(0xFF008B5E),
    secondaryDark = Color(0xFF8EE8C0),
    tertiaryLight = Color(0xFF006B45),
    tertiaryDark = Color(0xFFAAF0D1),
    backgroundLight = Color(0xFFF0FFF8),
    backgroundDark = Color(0xFF001A0E),
  ),
  DarkPink(
    titleRes = R.string.theme_dark_pink,
    primaryLight = Color(0xFF880E4F),
    primaryDark = Color(0xFFF48FB1),
    secondaryLight = Color(0xFFAD1457),
    secondaryDark = Color(0xFFF06292),
    tertiaryLight = Color(0xFF6A0036),
    tertiaryDark = Color(0xFFFF80AB),
    backgroundLight = Color(0xFFFFF0F5),
    backgroundDark = Color(0xFF1A0010),
  ),
  YellowGold(
    titleRes = R.string.theme_yellow_gold,
    primaryLight = Color(0xFFF9A825),
    primaryDark = Color(0xFFFFD54F),
    secondaryLight = Color(0xFFF57F17),
    secondaryDark = Color(0xFFFFE082),
    tertiaryLight = Color(0xFFE65100),
    tertiaryDark = Color(0xFFFFCC80),
    backgroundLight = Color(0xFFFFFDE7),
    backgroundDark = Color(0xFF1A1400),
  ),
  DeepGold(
    titleRes = R.string.theme_deep_gold,
    primaryLight = Color(0xFFB8860B),
    primaryDark = Color(0xFFFFD700),
    secondaryLight = Color(0xFF8B6914),
    secondaryDark = Color(0xFFFFEC8B),
    tertiaryLight = Color(0xFF6B4F00),
    tertiaryDark = Color(0xFFFFC107),
    backgroundLight = Color(0xFFFFFBE6),
    backgroundDark = Color(0xFF0D0A00),
  ),
  RosePink(
    titleRes = R.string.theme_rose_pink,
    primaryLight = Color(0xFFE91E8C),
    primaryDark = Color(0xFFFF80C8),
    secondaryLight = Color(0xFFD81B60),
    secondaryDark = Color(0xFFFFB3D9),
    tertiaryLight = Color(0xFFC2185B),
    tertiaryDark = Color(0xFFFF4DA6),
    backgroundLight = Color(0xFFFFF0F8),
    backgroundDark = Color(0xFF1A0012),
  ),
  Magenta(
    titleRes = R.string.theme_magenta,
    primaryLight = Color(0xFFAA00FF),
    primaryDark = Color(0xFFE040FB),
    secondaryLight = Color(0xFF7B1FA2),
    secondaryDark = Color(0xFFCE93D8),
    tertiaryLight = Color(0xFF6200EA),
    tertiaryDark = Color(0xFFB388FF),
    backgroundLight = Color(0xFFFAF0FF),
    backgroundDark = Color(0xFF0D001A),
  ),
  Crimson(
    titleRes = R.string.theme_crimson,
    primaryLight = Color(0xFFDC143C),
    primaryDark = Color(0xFFFF6B8A),
    secondaryLight = Color(0xFFB71C1C),
    secondaryDark = Color(0xFFEF9A9A),
    tertiaryLight = Color(0xFF7F0000),
    tertiaryDark = Color(0xFFFF8A80),
    backgroundLight = Color(0xFFFFF5F5),
    backgroundDark = Color(0xFF1A0000),
  ),
  Sunflower(
    titleRes = R.string.theme_sunflower,
    primaryLight = Color(0xFFFFB300),
    primaryDark = Color(0xFFFFD740),
    secondaryLight = Color(0xFFFF8F00),
    secondaryDark = Color(0xFFFFE57F),
    tertiaryLight = Color(0xFFFF6F00),
    tertiaryDark = Color(0xFFFFD180),
    backgroundLight = Color(0xFFFFFDF0),
    backgroundDark = Color(0xFF1A1000),
  );
